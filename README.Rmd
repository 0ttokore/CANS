...
hierarchical clustering, k-means, DBSCAN and spectral method. 
Provides imitation model of nucleotide sequences.

## Installation

You can install the development version of CANS from [GitHub](https://github.com/) with:
